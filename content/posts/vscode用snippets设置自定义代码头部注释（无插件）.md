...
image: ../../public/images/20230313/IMG-C695BD726D761D3362BA811B1EC81782.png
tags:
  - 日常
  - vscode
category: 日常杂谈
...
另外一说，这个snippets本来的作用是用来添加自定义代码的，比如html文件输入"!"生成基础代码，js里输入"log"生成"console.log"
这些都是vscode内置的代码模块
